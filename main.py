...
def run_par_test(file_path, num_processes=range(4, 10)):
...
def main() -> None:
    ...
    """
    # add any .col .mtx graphs you wish to test to the list:
    graphs = ["in/C125.9.col", "in/brock200-1.mtx", "in/gen200_p0.9_44.col", "in/p_hat300-3.col"]
    for graph in graphs:
        res = run_test(graph)
